package com.vivid.myshop.OtherCategories;
...
public class OtherCategary extends Fragment {
RecyclerView recyclerView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
      View view= inflater.inflate(R.layout.fragment_other_categary, container, false);
        ...
        recyclerView=view.findViewById(R.id.itemrecycyleother);
