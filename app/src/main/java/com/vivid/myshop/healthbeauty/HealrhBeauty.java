package com.vivid.myshop.healthbeauty;
...
public class HealrhBeauty extends Fragment {
RecyclerView recyclerView;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
      View view= inflater.inflate(R.layout.fragment_healrh_beauty, container, false);
        ...
        recyclerView=view.findViewById(R.id.itemrecycylehealth);
        //showvalu();
